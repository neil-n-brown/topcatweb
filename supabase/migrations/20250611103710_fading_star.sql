/*
  # Smart Prioritization System for Swipe Feature

  1. Functions
    - get_randomized_cats_for_user: Returns exactly 20 photos with smart prioritization
    - get_photo_priority_stats: Returns priority statistics for debugging
    - calculate_exposure_scores: Updates exposure scores for fair distribution

  2. Priority System
    - Priority 1: Never seen by user (highest priority)
    - Priority 2: Seen but no interaction (medium priority)
    - Priority 3: Previously interacted (lowest priority)

  3. Smart Selection
    - Always returns exactly the requested number of photos
    - Fills with highest priority photos first
    - Randomizes within priority groups
    - Balances exposure scores for fairness
*/
